...
| Extended markdown pack             | Built-in non-GFM enhancements include preview TOC panel + `<!-- TOC -->` directive, superscript/subscript (`^...^`, `~...~`), highlight (`==...==`), and definition lists (`dl/dt/dd`). |
