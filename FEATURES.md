...
| Front matter properties panel      | Top-of-file YAML front matter renders as a properties panel in preview/export while headings, TOC, title, and favicon behavior use the Markdown body. Top-level boolean values render as tickable checkboxes that toggle the YAML source on click.                                                               |
