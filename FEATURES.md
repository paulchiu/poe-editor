...
| Front matter properties panel      | Top-of-file YAML front matter renders as a read-only properties panel in preview/export while headings, TOC, title, and favicon behavior use the Markdown body.                                                               |
