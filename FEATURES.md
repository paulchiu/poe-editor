...
| Print-friendly preview/export      | Browser print renders styled, non-interactive output (black-on-white), expands `details/summary` content, and forces Mermaid diagrams to a printer-friendly monochrome palette; printed HTML exports follow the same rules. |
