...
| Diff/patch syntax highlighting     | Fenced `diff` and `patch` code blocks render with green additions, red deletions, and themed file headers in both preview and HTML export.                                                                                                                                                                            |
...
| Preview font-size controls         | Interactive preview panes include floating controls to increase or decrease reading size in 5% steps; controls remain visible on touch devices, and the bounded setting persists across sessions without changing print-friendly output.                                                                              |
